...
/* harmony import */ var D_repos_nice_ai_agent_study_resources_node_modules_lunr_lunr_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(58291);
/* harmony import */ var D_repos_nice_ai_agent_study_resources_node_modules_lunr_lunr_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(D_repos_nice_ai_agent_study_resources_node_modules_lunr_lunr_js__WEBPACK_IMPORTED_MODULE_0__);
__webpack_require__(12472)((D_repos_nice_ai_agent_study_resources_node_modules_lunr_lunr_js__WEBPACK_IMPORTED_MODULE_0___default()));(__webpack_require__(9150)/* .lunrLanguageZh */ .A)((D_repos_nice_ai_agent_study_resources_node_modules_lunr_lunr_js__WEBPACK_IMPORTED_MODULE_0___default()));__webpack_require__(49631)((D_repos_nice_ai_agent_study_resources_node_modules_lunr_lunr_js__WEBPACK_IMPORTED_MODULE_0___default()));const removeDefaultStopWordFilter=false;const language=["zh","en"];const searchIndexUrl="search-index{dir}.json?_=22b5b13a";const searchResultLimits=8;const fuzzyMatchingDistance=1;
...
const stopWordPipelines=[];for(const lang of _proxiedGeneratedConstants__WEBPACK_IMPORTED_MODULE_2__/* .language */ .BH){if(lang==="en"){if(!_proxiedGeneratedConstants__WEBPACK_IMPORTED_MODULE_2__/* .removeDefaultStopWordFilter */ .sx){stopWordPipelines.unshift((lunr__WEBPACK_IMPORTED_MODULE_0___default().stopWordFilter));}}else{const lunrLang=(lunr__WEBPACK_IMPORTED_MODULE_0___default())[lang];if(lunrLang.stopWordFilter){stopWordPipelines.unshift(lunrLang.stopWordFilter);}}}let refinedTerms;if(stopWordPipelines.length>0){const pipe=term=>stopWordPipelines.reduce((term,p)=>term.filter(item=>p(item.value)),term);refinedTerms=[];const newTerms=[];for(const term of terms){const filteredTerm=pipe(term);refinedTerms.push(filteredTerm);// Add extra terms only if some stop words are removed,
